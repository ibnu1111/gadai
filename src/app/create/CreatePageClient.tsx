      ...
      <main className="max-w-xl mx-auto px-4 py-10 -mt-4">
        <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-8 border border-gray-100">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="customerName" className="block text-sm font-medium text-gray-700 mb-1.5">Nama Lengkap</label>
              <input
                id="customerName"
                type="text"
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-gray-700 mb-1.5">Nomor WhatsApp</label>
              <input
                id="phone"
                type="tel"
            ...
            <div>
              <label htmlFor="kategoriBarang" className="block text-sm font-medium text-gray-700 mb-1.5">Kategori Barang</label>
              <select
                id="kategoriBarang"
            ...
            <div>
              <label htmlFor="namaBarang" className="block text-sm font-medium text-gray-700 mb-1.5">Nama Barang</label>
              <input
                id="namaBarang"
                type="text"
            ...
            <div>
              <label htmlFor="deskripsi" className="block text-sm font-medium text-gray-700 mb-1.5">Deskripsi</label>
              <textarea
                id="deskripsi"
            ...
            <div>
              <label htmlFor="nominalPinjam" className="block text-sm font-medium text-gray-700 mb-1.5">Nominal Pinjaman (Rp)</label>
              <input
                id="nominalPinjam"
                type="number"
            ...
            <div>
              <p className="block text-sm font-medium text-gray-700 mb-3">Jangka Waktu</p>
...
export default function CreatePageClient() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          { name: 'Beranda', url: 'https://gadaijogja.com/' },
          { name: 'Ajukan Gadai', url: 'https://gadaijogja.com/create' },
        ]}
      />
      <Suspense fallback={
